...
import re
import numpy as np
from src.utils.check.qwen_equal import math_equal
import json
import copy
from abc import ABC
...
from src.models import Actor, GPTLMLoss, PolicyLoss, ValueLoss
from src.models.utils import masked_mean
...
x
    ...
    def get_prompt2answer(self):
        ...
        self.sources=[]
        for line in data:
            self.prompt2answer[line['prompt'].strip()]=str(line['answer'])
