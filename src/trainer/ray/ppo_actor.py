...
from src.datasets import PromptDataset, SFTDataset
from src.models import Actor
from src.trainer import PPOTrainer
from src.trainer.ppo_utils import Experience, RemoteExperienceMaker
from src.utils import blending_datasets, get_tokenizer
from src.utils.deepspeed import DeepspeedStrategy
from src.utils.distributed_util import init_process_group
...
class ActorModelRayActor(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        ...
        actor_scheduler = get_scheduler(
            ...
            scheduler_specific_kwargs={"min_lr": args.actor_learning_rate * 0.8},
        )
    ...
    def prepare_datasets(self):
        ...
        self.eval_dataloader = strategy.setup_dataloader(
            self.eval_dataset, args.evaluation_batch_size // strategy.world_size, True, shuffle=False
        )
